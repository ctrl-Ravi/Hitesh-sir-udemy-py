...
city = input("Whice city do you live in? ").strip()
profession = input("What is your proffession? ").strip()
hobby = input("What is your favourite hobby? ").strip()

intro_message = (
        f"Hello! my name is {name}, I'm {age} years old and live in {city} "
        f"I work as a {profession} and I abosolutely enjoy {hobby} in my free time \n"
        f"Nice to meet you!\n"
)
