...
def main():
    collected=[]
    current_url = urljoin(URL, START_PAGE)
    while len(collected)<TARGET_COUNT and current_url:
        ...
        current_url=next_url #urljoin always receives an absolute base URL from the previous iteration'
    ...
    print(f"Data save to {JSON_FILE}")
